...
return {
  ...
  dungeon = {
    -- Blim Blim
    OhFinally = "Oh, finally found Blim Blim!",
    MaybeICan = "Maybe I can free her if I eat all this jelly?",
    OhOh = "Oh-oh...",
    BlimBlim = "Blim Blim!",
    BlimAreYou = "Blim, are you okay?",
    WhereIsIt = "Where is it, where is it???",
    DidItRun = "Huh? Where is the jelly? Did it run away?",
    WhichOne = "Hmm... which one? The one that swallowed you?",
    Swallowed = "Whaaat?? Swallowed??",
    NowIRemember = "Oh, now I remember... That thing got me by surprise!",
    ImGonnaFinishIt = "Where is it??? I'm gonna finish it!!!",
    AlreadyGot = "Oh, I already got rid of it, no need to worry!",
    WhatSad = "What...?",
    NoFun = "Aaaaw... it's no fun anymore!",
    HuhPomPom = "Huh... Isn't Pom Pom with you?",
    ...
    TheCat = "The... the cat...",
    WhatCat = "Uh? What cat?",
    ISawHim = "The cat! A black cat! I saw him! He's the one creating these jellies!",
