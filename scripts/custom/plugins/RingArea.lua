...
Notes:
- If the near value is bigger than the far value, the set is empty.
- If far and near values are the same value X, the ring is the set of tiles that distantiates from
